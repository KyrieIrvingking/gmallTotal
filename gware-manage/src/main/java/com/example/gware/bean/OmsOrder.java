...
public class OmsOrder implements Serializable {
    ...
    List<com.example.gware.bean.OmsOrderItem> omsOrderItems ;

    public List<com.example.gware.bean.OmsOrderItem> getOmsOrderItems() {
        return omsOrderItems;
    }

    public void setOmsOrderItems(List<com.example.gware.bean.OmsOrderItem> omsOrderItems) {
